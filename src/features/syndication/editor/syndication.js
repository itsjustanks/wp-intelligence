(function () {
  ...
  function SyndicationPanel() {
    ...
    var strategyLabel = config.fetchStrategy === 'firecrawl'
      ? __('via Firecrawl', 'wp-intelligence')
      : __('via Built-in', 'wp-intelligence');
    ...
    return el(
      ...
      el(
        ...
        el('span', {
          style: { fontSize: '11px', color: '#757575', marginBottom: '-4px' },
        }, '⚡ ' + strategyLabel),
