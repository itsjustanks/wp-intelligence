...
require_once WPI_BV_DIR . '/integrations/edd/rule-tests.php';
require_once WPI_BV_DIR . '/integrations/edd/helper-functions.php';
...
add_filter( 'wpi_visibility_control_set_is_block_visible', __NAMESPACE__ . '\edd_test', 15, 3 );
