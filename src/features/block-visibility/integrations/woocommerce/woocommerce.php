...
require_once WPI_BV_DIR . '/integrations/woocommerce/rule-tests.php';
require_once WPI_BV_DIR . '/integrations/woocommerce/helper-functions.php';
...
add_filter( 'wpi_visibility_control_set_is_block_visible', __NAMESPACE__ . '\woocommerce_test', 15, 3 );
