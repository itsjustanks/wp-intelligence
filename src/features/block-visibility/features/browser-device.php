...
use WPI\Visibility\Vendors\Wolfcast\BrowserDetection;
...
add_filter( 'wpi_visibility_control_set_is_block_visible', __NAMESPACE__ . '\browser_device_test', 10, 3 );
...
require_once WPI_BV_DIR . '/vendors/browser-detection.php';
