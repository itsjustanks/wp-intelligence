...
add_filter( 'wpi_visibility_is_block_visible', __NAMESPACE__ . '\visibility_presets_test', 10, 3 );
...
add_filter( 'wpi_visibility_add_custom_classes', __NAMESPACE__ . '\visibility_presets_add_custom_classes', 10, 3 );
