...
use function WPI\Visibility\Utils\get_setting;
...
add_filter( 'wpi_visibility_control_set_is_block_visible', __NAMESPACE__ . '\screen_size_test', 10, 3 );
...
add_filter( 'wpi_visibility_control_set_add_custom_classes', __NAMESPACE__ . '\add_screen_size_classes', 10, 3 );
