 ...
 */
use function WPI\Visibility\Utils\get_user_roles;
use function WPI\Visibility\Utils\get_current_user_role;
 ...
 */
class WPI_Visibility_REST_Variables_Controller extends WP_REST_Controller {
	...
	public function get_item_schema() {
		...
		$schema = array(
			...
			'properties' => array(
				'current_users_roles'  => array(
					'description' => __( 'The roles assigned to the current user.', 'wp-intelligence' ),
					'type'        => 'array',
					'readonly'    => true,
				),
				'user_roles'           => array(
					'description' => __( 'The available user roles on the site.', 'wp-intelligence' ),
					'type'        => 'array',
					'readonly'    => true,
				),
				'plugin_variables'     => array(
					'description' => __( 'An array of plugin variables, such as version number.', 'wp-intelligence' ),
					'type'        => 'array',
					'readonly'    => true,
				),
				'is_full_control_mode' => array(
					'description' => __( 'An indicator to determine if full control mode is enabled.', 'wp-intelligence' ),
					'type'        => 'boolean',
					'readonly'    => true,
				),
				'is_pro'               => array(
					'description' => __( 'An indicator to determine if Block Visibility Pro is enabled.', 'wp-intelligence' ),
					'type'        => 'boolean',
					'readonly'    => true,
				),
				'integrations'         => array(
					'description' => __( 'All integration related information.', 'wp-intelligence' ),
					'type'        => 'object',
					'properties'  => array(
						'acf'         => array(
							'type'       => 'object',
		...
		$this->schema = apply_filters(
			'wpi_visibility_rest_variables_schema',
			$schema
		);
