 ...
 */
class WPI_Visibility_REST_Settings_Controller extends WP_REST_Controller {
	...
	public function update_settings( $request ) {
		...
		$error_message = __( 'Something went wrong, the settings could not be updated.', 'wp-intelligence' );
