...
class WP_Intelligence_Admin_Columns {
  ...
  public static function column_styles(): void {
    ...
    echo "<style>"
       ...
       . ".wp-list-table.fixed .column-title{width:25%;overflow:hidden;text-overflow:ellipsis;}"
       . ".wp-list-table.fixed .column-{$p}{width:14%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}"
       . ".wp-list-table.fixed .column-{$p} a{display:block;overflow:hidden;text-overflow:ellipsis;}"
       . ".wp-list-table.fixed .column-{$t}{width:7%;}"
       . "</style>";
  }
